...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?php echo e(route("admin.sales.update", [$sale->id])); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <table class="table table-bordered" id="product_info_table">
                 ...
                 <tbody id="product-info">
                       <!-- Product info  -->
                       <?php $__currentLoopData = $sale->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $pd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <tr id="row_<?php echo e($id + 1); ?>" class="product">
                            <td>
                                 <select class="form-control" id="product_<?php echo e($id + 1); ?>" name="products[]" style="width:100%;" onchange="getProductData(<?php echo e($id + 1); ?>)" required>
                                      <option value=""> <?php echo e(trans('global.pleaseSelect')); ?> </option>
                                      <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <option value="<?php echo e($product->id); ?>" <?php echo e((isset($sale) && $sale->products ? $sale->products[$id]->id : old('product_id')) == $product->id ? 'selected' : ''); ?> >
                            ...
                            <td>
                                 <input type="number" min="1" name="quantities[]" id="quantity_<?php echo e($id + 1); ?>" class="form-control" value="1" required onchange="getTotal(1)" onkeyup="getTotal(1)">
                            </td>
                            <td>
                                 <input type="number" id="rate_<?php echo e($id + 1); ?>" value="<?php echo e($pd->price); ?>" name="rates[]" class="form-control" readonly>
                            </td>
                            <td>
                                 <input type="number" name="price[]" id="price_<?php echo e($id + 1); ?>" value="<?php echo e($pd->price); ?>" class="form-control price" readonly>
                            </td>
                            <td>
            ...
            <div class="form-row">
                 ...
                 <div class="col-6">
                    ...
                    <input type="number" step="any" min="0" id="discount" name="discount" class="form-control" value="<?php echo e($sale->discount ?? 0); ?>" onchange="getAmount()" onkeyup="getAmount()">
...
<script type="text/javascript" defer>
     ...
     document.addEventListener("DOMContentLoaded", function(event){
          $("#amount").val($("#total").val() - $("#discount").val());
     });
</script>

<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbook/Programming/sith/laramission/resources/views/admin/sales/edit.blade.php ENDPATH**/ ?>