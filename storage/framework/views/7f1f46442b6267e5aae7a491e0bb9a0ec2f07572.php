...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?php echo e(route("admin.expenses.update", [$expense->id])); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbook/Programming/sith/laramission/resources/views/admin/expenses/edit.blade.php ENDPATH**/ ?>