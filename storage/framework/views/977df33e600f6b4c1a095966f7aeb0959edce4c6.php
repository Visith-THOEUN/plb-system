    ...
    <div class="card-body">
        <form action="<?php echo e(route("admin.employees.store")); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group <?php echo e($errors->has('salary') ? 'has-error' : ''); ?>">
                ...
                <input type="number" id="salary" name="salary" class="form-control" value="<?php echo e(old('salary', isset($salary) ? $employee->salary : '')); ?>" required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbook/Programming/sith/laramission/resources/views/admin/employees/create.blade.php ENDPATH**/ ?>