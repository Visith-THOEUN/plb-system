...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('income_category_create')): ?>
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="<?php echo e(route("admin.incomeCategories.create")); ?>">
                        ...
                        <tr data-entry-id="<?php echo e($category->id); ?>">
                            ...
                            <td>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('income_category_show')): ?>
                                    <a class="btn btn-xs btn-primary" href="<?php echo e(route('admin.incomeCategories.show', $category->id)); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('expense_category_edit')): ?>
                                    <a class="btn btn-xs btn-info" href="<?php echo e(route('admin.incomeCategories.edit', $category->id)); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('expense_category_delete')): ?>
                                    <form action="<?php echo e(route('admin.incomeCategories.destroy', $category->id)); ?>" method="POST" onsubmit="return confirm('<?php echo e(trans('global.areYouSure')); ?>');" style="display: inline-block;">
...
<script>
    $(function () {
         ...
         let deleteButton = {
             ...
             url: "<?php echo e(route('admin.incomeCategories.massDestroy')); ?>",
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbook/Programming/sith/laramission/resources/views/admin/incomeCategories/index.blade.php ENDPATH**/ ?>