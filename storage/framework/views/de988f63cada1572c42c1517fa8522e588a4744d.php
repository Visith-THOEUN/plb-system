    ...
    <div class="card-body">
        <form action="<?php echo e(route("admin.products.store")); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group <?php echo e($errors->has('sku') ? 'has-error' : ''); ?>">
                ...
                <input type="text" id="sku" name="sku" class="form-control" value="<?php echo e(old('sku', isset($product) ? $sku->name : '')); ?>" required>
            ...
            <div class="form-group <?php echo e($errors->has('price') ? 'has-error' : ''); ?>">
                <label for="quantity"><?php echo e(trans('cruds.product.fields.price')); ?>*</label>
                <input placeholder="$" type="text" id="price" name="price" class="form-control" value="<?php echo e(old('price', isset($product) ? $product->name : '')); ?>" required>
            ...
            <div class="form-group <?php echo e($errors->has('quantity') ? 'has-error' : ''); ?>">
               ...
               <input type="text" id="quantity" name="quantity" class="form-control" value="<?php echo e(old('quantity', isset($product) ? $product->quantity : '')); ?>" required>
               <?php if($errors->has('name')): ?>
                    <p class="help-block">
                        <?php echo e($errors->first('name')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbook/Programming/sith/laramission/resources/views/admin/products/create.blade.php ENDPATH**/ ?>